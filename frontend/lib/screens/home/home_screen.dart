...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final _popular = const [
    _PopularItem('AC Service', 'from ₨1,500', 'Today', Color(0xFFFCD24A), Icons.ac_unit_rounded),
    _PopularItem('Plumbing', 'from ₨800', '2hr ETA', Color(0xFFFFE988), Icons.plumbing_rounded),
    _PopularItem('Deep Clean', 'from ₨3,500', 'Tomorrow', Color(0xFFF4EFE2), Icons.cleaning_services_rounded),
    _PopularItem('Maths Tutor', 'from ₨1,200/hr', 'Verified', Color(0xFFFFF5C2), Icons.menu_book_rounded),
  ];
                      ...
                      SafeArea(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ).animate().fadeIn(delay: 100.ms, duration: 400.ms).slideY(begin: 0.2, end: 0, duration: 400.ms, delay: 100.ms),
                          ],
                        ),
                      ),
                    ],
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: const Icon(Icons.arrow_forward_rounded,
                                  size: 16, color: EzColors.yellow),
                            ),
                          ],
                        ),
                      ),
                    ),
                  ).animate().fadeIn(delay: 200.ms, duration: 400.ms).slideY(begin: 0.15, end: 0, delay: 200.ms, duration: 400.ms),
                ),
